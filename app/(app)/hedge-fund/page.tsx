...
import RejectionBreakdownPanel from "@/components/hedge-fund/RejectionBreakdownPanel";
...
import RunHistoryPanel from "@/components/hedge-fund/RunHistoryPanel";
import ValidationProgressPanel from "@/components/hedge-fund/ValidationProgressPanel";
import QuantMemoryPanel from "@/components/hedge-fund/QuantMemoryPanel";
import TestHarnessPanel from "@/components/hedge-fund/TestHarnessPanel";
import WhileYouWereAwayPanel from "@/components/hedge-fund/WhileYouWereAwayPanel";
 ...
 */
import QuantNowStrip from "@/components/hedge-fund/QuantNowStrip";
import MomentumRadarPlaceholder from "@/components/hedge-fund/MomentumRadarPlaceholder";
import StrategyPlaybooksPlaceholder from "@/components/hedge-fund/StrategyPlaybooksPlaceholder";
...
export default async function HedgeFundPage() {
    ...
    return (
        <div className="text-white">
            ...
            <div className="mb-2">
                <p className="text-xs font-semibold uppercase tracking-wide text-zinc-500">Live Fund Status</p>
            </div>
            <div className="mb-6">
                <SystemStatusPanel />
            </div>
            ...
            <div className="mb-2">
                <p className="text-xs font-semibold uppercase tracking-wide text-zinc-500">Autonomous Execution Funnel</p>
            </div>
            ...
            <div className="mb-2">
                <p className="text-xs font-semibold uppercase tracking-wide text-zinc-500">Why Quant Is Not Trading</p>
            </div>
            <div className="mb-6">
            ...
            <div className="mb-2">
                <p className="text-xs font-semibold uppercase tracking-wide text-zinc-500">Quant Activity</p>
            </div>
            <div className="mb-6">
                <ActivityFeedPanel />
            </div>
            ...
            <div className="mb-2">
                <p className="text-xs font-semibold uppercase tracking-wide text-zinc-500">Open Positions</p>
            </div>
            <div className="mb-6">
            ...
            <div className="mt-6 mb-2">
                <p className="text-xs font-semibold uppercase tracking-wide text-zinc-500">Fund Health / Risk</p>
            </div>
            {risk.success && risk.report && (
                <div className="mb-6">
            ...
            <div className="mb-2">
                <p className="text-xs font-semibold uppercase tracking-wide text-zinc-500">Quant Control</p>
            </div>
            <div className="mb-6">
                <QuantControlPanel />
            </div>
            ...
            <div className="mb-2">
                <p className="text-xs font-semibold uppercase tracking-wide text-zinc-500">Validation</p>
            </div>
            <div className="mb-6">
                <ValidationProgressPanel />
            </div>
            <div className="mb-6">
                <TestHarnessPanel defaultWatchlist="RIOT, IREN, RKLB, KTOS, CLSK" />
            </div>

            <div className="mb-2">
                <p className="text-xs font-semibold uppercase tracking-wide text-zinc-500">Quant Memory</p>
            </div>
            <div className="mb-6">
                <QuantMemoryPanel />
            </div>

            <StrategyPlaybooksPlaceholder />

            <div className="mb-2">
                <p className="text-xs font-semibold uppercase tracking-wide text-zinc-500">Trade History</p>
            </div>
            <div className="mb-6">
                <ClosedTradesPanel />
            </div>
