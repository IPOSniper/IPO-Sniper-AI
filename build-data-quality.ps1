...
[System.IO.File]::WriteAllText(
    (Resolve-Path "engine\quant\decisionMatrix" | Join-Path -ChildPath "dataQuality.ts"),
    $content,
    (New-Object System.Text.UTF8Encoding($false))
)

Write-Host "PATCHED: dataQuality.ts created." -ForegroundColor Green

Write-Host "`n=== VERIFY ===" -ForegroundColor Cyan
Get-Item "engine\quant\decisionMatrix\dataQuality.ts" | Select-Object Name, Length
