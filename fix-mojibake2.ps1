...
Write-Host ""
Write-Host "=== Fixing CurrentOpportunitiesPanel.tsx ===" -ForegroundColor Cyan
Fix-File $oppPath @(
    'ÃƒÂ¢Ã¢â‚¬â€', '-'
)

Write-Host ""
Write-Host "=== VERIFY (should show ZERO remaining matches in both files) ===" -ForegroundColor Cyan
