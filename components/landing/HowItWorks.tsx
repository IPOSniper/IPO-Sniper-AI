    ...
    return (
        <section className="border-t border-zinc-900 bg-black px-6 py-24 text-white">
            <div className="mx-auto max-w-5xl">
                ...
                <p className="mt-4 text-center text-base sm:text-lg font-medium text-violet-300 bg-violet-950/20 border border-violet-800/40 rounded-lg py-2 px-4 w-fit mx-auto">
